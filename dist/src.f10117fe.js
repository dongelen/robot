...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"public/car3.png":[function(require,module,exports) {
module.exports = "/car3.43daa84c.png";
},{}],"public/car_backlights.png":[function(require,module,exports) {
...
},{}],"public/background_level2.png":[function(require,module,exports) {
module.exports = "/background_level2.7439f816.png";
},{}],"public/background_level3.png":[function(require,module,exports) {
module.exports = "/background_level3.b6af70b0.png";
},{}],"public/background_level4.png":[function(require,module,exports) {
module.exports = "/background_level4.d9dc24f0.png";
},{}],"public/background_level5.png":[function(require,module,exports) {
module.exports = "/background_level5.08fc5bcb.png";
...
},{}],"src/robot.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  Robot.prototype.calculateForwardXMovement = function () {
    if (this.rotation < 0) {
  ...
  Robot.prototype.calculateBackwardXMovement = function () {
    if (this.rotation >= 0 && this.rotation < 90) {
      return -1;
    } else if (this.rotation === 90) {
      return 0;
  ...
  Robot.prototype.calculateBackwardYMovement = function () {
    if (this.rotation === 0 || this.rotation === 180) {
      return 0;
    } else if (this.rotation > 0 && this.rotation < 180) {
      return -1;
  ...
  Robot.prototype.check = function () {
  ...
  Robot.prototype.doeIets = function () {
    var robot = this;
  ...
  Robot.prototype.findElement = function (name) {
    for (var _i = 0, _a = this.element.childNodes; _i < _a.length; _i++) {
      var element = _a[_i];
  ...
  Robot.prototype.findElementIn = function (name, parentElement) {
    for (var _i = 0, _a = parentElement.childNodes; _i < _a.length; _i++) {
      var element = _a[_i];
  ...
  Robot.prototype.headlights = function (on) {
    var headlights = this.findElement("headlights");
    var opacitiyGoal = on ? 1 : 0;
    this.animationTimeLine.add({
      targets: headlights,
  ...
  Robot.prototype.backlights = function (on) {
    var car = this.findElement("car");
    var carbacklight = this.findElementIn("carbacklight", car);
    this.animationTimeLine.add({
  ...
  Robot.prototype.blinkHeadlights = function (times) {
    if (times === void 0) {
      times = 1;
    }
...
exports.Robot = Robot;
},{"animejs/lib/anime.es.js":"node_modules/animejs/lib/anime.es.js"}],"src/level.ts":[function(require,module,exports) {
"use strict";
...
var car3_png_1 = __importDefault(require("/public/car3.png"));
...
var background_level2_png_1 = __importDefault(require("/public/background_level2.png"));

var background_level3_png_1 = __importDefault(require("/public/background_level3.png"));

var background_level4_png_1 = __importDefault(require("/public/background_level4.png"));

var background_level5_png_1 = __importDefault(require("/public/background_level5.png"));
...
function () {
  ...
  Goal.prototype.moved = function (_robot, _from, _to) {};

  Goal.prototype.finishedAt = function (_robot, _endPosition) {};

  Goal.prototype.isSatified = function () {
...
/** @class */
function (_super) {
  __extends(GoalLevel2, _super);

  function GoalLevel2() {
    var _this = _super !== null && _super.apply(this, arguments) || this;

    _this.hitPosition = false;
    return _this;
  }
...
/** @class */
function (_super) {
  __extends(GoalLevel3, _super);

  function GoalLevel3() {
    return _super !== null && _super.apply(this, arguments) || this;
  }

  GoalLevel3.prototype.finishedAt = function (robot, endPosition) {
    _super.prototype.finishedAt.call(this, robot, endPosition);
...
/** @class */
function () {
  function Level(goal, canvases, numberOfRows, numberOfColumns) {
    this.fields = [];
...
function (_super) {
  ...
  Level2.prototype.afterInit = function () {
    this.audioEndID = "j2";
  };
...
function (_super) {
  ...
  Level3.prototype.afterInit = function () {
    this.audioEndID = "j3";
  };
...
function (_super) {
  ...
  Level4.prototype.afterInit = function () {
    this.audioEndID = "j4";
  };
...
function () {
  ...
  Game.prototype.makeLevel1 = function (element) {
    var code = this.createHTMLContainer(background_level1_png_1.default, 700, 200, 1, 3);
  ...
  Game.prototype.makeLevel2 = function (element) {
    var nr = 2;
    var nc = 3;
    var code = this.createHTMLContainer(background_level2_png_1.default, 700, 400, nr, nc);
    element.innerHTML = code;
    var level1 = document.getElementById("layer1");
    var robot = document.getElementById("robot");
    var l = new Level2(new GoalLevel2(), [level1, robot], nr, nc);
    l.draw();
    return l;
  };

  Game.prototype.makeLevel3 = function (element) {
    var nr = 2;
    var nc = 3;
    var code = this.createHTMLContainer(background_level3_png_1.default, 700, 400, nr, nc);
    element.innerHTML = code;
    var level1 = document.getElementById("layer1");
    var robot = document.getElementById("robot");
    var l = new Level3(new GoalLevel3(), [level1, robot], nr, nc);
    l.draw();
    return l;
  };

  Game.prototype.makeLevel4 = function (element) {
    var nr = 8;
    var nc = 14;
    var code = this.createHTMLContainer(background_level4_png_1.default, 700, 400, nr, nc);
    element.innerHTML = code;
    var level1 = document.getElementById("layer1");
    var robot = document.getElementById("robot");
  ...
  Game.prototype.makeLevel5 = function (element) {
    var nr = 8;
    var nc = 14;
    var code = this.createHTMLContainer(background_level5_png_1.default, 700, 400, nr, nc);
    element.innerHTML = code;
    var level1 = document.getElementById("layer1");
    var robot = document.getElementById("robot");
  ...
  Game.prototype.createHTMLContainer = function (levelBackgroundImage, width, height, numberOfRows, numberOfColumns) {
    ...
    var backgroundImage = levelBackgroundImage;
